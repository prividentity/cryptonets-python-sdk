...
def setup_compare_test(image1_filename=None, image2_filename=None, operation_threshold_parameter_name=None, threshold_value=0, use_cache=False,
               call_context='predict'):
...
if __name__ == "__main__":
    ...
    (face_factor,image_path,) = setup_test("8.png",)
    (face_factor,img1,img2) = setup_compare_test("3_predict_cropped_images_0.png","8.png")
