...
class Jpg19:
    def __init__(self):
        ...
        self.get_iso_result = ISOFaceResult(
            ...
            iso_image_width=360,
            iso_image_channels=3,
            confidence=0.11450446397066116,
        )
        self.compare_result = FaceCompareResult(
            status=FaceCompareResult.CALL_STATUS_SUCCESS,
            result=1,
