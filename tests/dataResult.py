...
class Jpg1:
    def __init__(self):
        ...
        self.predict_result = FaceEnrollPredictResult(status=FaceEnrollPredictResult.CALL_STATUS_SUCCESS, message="OK", enroll_level=1)
...
class Png16:
    ...
    def set_face_objects(self):
        ...
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ChinTooFarRight.value,
                                                     ...
                                                     top_left_coordinate={"x": 342.0, "y": 122.0},
                                                     bottom_right_coordinate={"x": 490.0, "y": 270.0})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.NoFace.value,
                                                     message=FaceValidationCode.NoFace.name, age=-1.0,
                                                     top_left_coordinate={"x": 45.0, "y": 110.0},
                                                     bottom_right_coordinate={"x": 187.0, "y": 242.0})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=22.1702880859375,
                                                     top_left_coordinate={"x": 637.5, "y": 128.5},
                                                     bottom_right_coordinate={"x": 776.5, "y": 265.5})
...
class Jpg19:
    def __init__(self):
        self.is_valid_result = FaceValidationResult(error=0, message="OK")
        self.estimate_age_result = FaceValidationResult(error=0, message="OK")
        self.get_iso_result = ISOFaceResult(status=3, message="ISO face validation failed.")
        self.compare_result = FaceCompareResult(status=FaceCompareResult.CALL_STATUS_SUCCESS, result=1,
                                                first_validation_result=FaceValidationCode.ValidBiometric.value,
                                                second_validation_result=FaceValidationCode.ValidBiometric.value)
        self.enroll_result = FaceEnrollPredictResult(status=FaceEnrollPredictResult.CALL_STATUS_SUCCESS, message="OK")
    ...
    def set_face_objects(self):
        ...
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     ...
                                                     bottom_right_coordinate={"x": 143.0, "y": 106.5})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=25.790895462036133,
                                                     top_left_coordinate={"x": 288.0, "y": 66.5},
                                                     bottom_right_coordinate={"x": 314.0, "y": 93.5})
...
class Jpg20:
    ...
    def set_face_objects(self):
        ...
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=14.596866607666016,
                                                     top_left_coordinate={"x": 59.0, "y": 48.5},
                                                     bottom_right_coordinate={"x": 99.0, "y": 89.5})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=17.12334632873535,
                                                     top_left_coordinate={"x": 279.0, "y": 56.5},
                                                     bottom_right_coordinate={"x": 319.0, "y": 99.5})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=11.554624557495117,
                                                     top_left_coordinate={"x": 168.5, "y": 67.0},
                                                     bottom_right_coordinate={"x": 205.5, "y": 107.0})
...
class Jpeg4:
    ...
    def set_face_objects(self):
        ...
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=23.95326805114746,
                                                     top_left_coordinate={"x": 100.5, "y": 63.0},
                                                     bottom_right_coordinate={"x": 193.5, "y": 159.0})
...
class Jpeg9:
    def __init__(self):
        ...
        self.enroll_result = FaceEnrollPredictResult(status=FaceEnrollPredictResult.CALL_STATUS_SUCCESS, message="Ok")
        self.predict_result = FaceEnrollPredictResult(status=FaceEnrollPredictResult.CALL_STATUS_SUCCESS, code=-1,
                                                      message="User not enrolled", enroll_level=None)
        self.delete_result = FaceDeleteResult(status=0, message="Ok")
        self.set_face_objects()
...
class Jpeg12:
    ...
    def set_face_objects(self):
        ...
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=18.01043701171875,
                                                     top_left_coordinate={"x": 151.5, "y": 478.5},
                                                     bottom_right_coordinate={"x": 548.5, "y": 913.5})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=19.81570816040039,
                                                     top_left_coordinate={"x": 881.0, "y": 330.5},
                                                     bottom_right_coordinate={"x": 1281.0, "y": 757.5})
...
class Png11:
    def __init__(self):
        self.is_valid_result = FaceValidationResult(error=0, message="OK")
        self.estimate_age_result = FaceValidationResult(error=0, message="OK")
        self.get_iso_result = ISOFaceResult(status=19, message="ISO face validation failed.")
        self.compare_result = FaceCompareResult(status=FaceCompareResult.CALL_STATUS_SUCCESS, result=1,
                                                first_validation_result=FaceValidationCode.ValidBiometric.value,
                                                second_validation_result=FaceValidationCode.ValidBiometric.value)
        self.enroll_result = FaceEnrollPredictResult(status=FaceEnrollPredictResult.CALL_STATUS_SUCCESS, message="Ok")
    ...
    def set_face_objects(self):
        ...
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=24.499250411987305,
                                                     top_left_coordinate={"x": 233.5, "y": 178.0},
                                                     bottom_right_coordinate={"x": 368.5, "y": 312.0})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.ValidBiometric.value,
                                                     message=FaceValidationCode.ValidBiometric.name, age=42.65743637084961,
                                                     top_left_coordinate={"x": 429.5, "y": 123.5},
                                                     bottom_right_coordinate={"x": 548.5, "y": 246.5})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.NoFace.value,
                                                     message=FaceValidationCode.NoFace.name, age=-1,
                                                     top_left_coordinate={"x": 65.5, "y": 108.5},
                                                     bottom_right_coordinate={"x": 180.5, "y": 223.5})
        self.estimate_age_result.append_face_objects(return_code=FaceValidationCode.NoFace.value,
                                                     message=FaceValidationCode.NoFace.name, age=-1,
