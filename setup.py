...
setup(
    ...
    project_urls={
        ...
        "Documentation": "https://docs.private.id/cryptonets-python-sdk/1.3.11b1/index.html",
        "Release Notes": "https://docs.private.id/cryptonets-python-sdk/1.3.11b1/changelog.html",
    },
    classifiers=[
